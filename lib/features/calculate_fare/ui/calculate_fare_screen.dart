...
class CalculateFareScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(S.of(context).calculateFare)),
      body: SafeArea(
                      ...
                      children:
                          [
                            StationsAutocomplete(
                              ...
                              validate: () {
                                if (startingStation == destinationStation) {
                                  return S.of(context).sameStationError;
                                }
                                return null;
                              },
                              title: S.of(context).fromStation,
                              hint: S.of(context).selectStartStation,
                            ),
                            ...
                            StationsAutocomplete(
                              ...
                              title: S.of(context).toStation,
                              hint: S.of(context).selectDestinationStation,
                            ),
                                ...
                                if (state is LoadingState) {
                                  ...
                                  return Column(
                                    children:
                                                  ...
                                                  ...[
                                                    ...
                                                    [
                                                      ...
                                                      S
                                                          .of(context)
                                                          .estimatedTime,
                                                      "${state.estimatedTime} ${S.of(context).minutes}",
                                                    ],
                                                    [
                                                      Icons
                                                          .monetization_on_outlined,
                                                      S.of(context).ticketPrice,
                                                      "${state.ticketPrice} ${S.of(context).egp}",
                                                    ],
                                                  ].map(
                                                    (e) => Container(
                                        ...
                                        ].animate(interval: .05.seconds).fadeIn().slideY(),
                                  );
                                }
                                return Container();
                              },
